#ifndef __FACIAL_POSE_ESTIMATOR_H_
#define __FACIAL_POSE_ESTIMATOR_H_
...
CV_INLINE bool estimateEav(const std::vector<cv::Point>& ldmarks, std::vector<float>& eavs)
{
	if (ldmarks.size() < 1)
		return false;
...
#endif /* __FACIAL_POSE_ESTIMATOR_H_ */
