...
FaceModelParameters::FaceModelParameters()
{
	...
	window_sizes_init[0] = 15; window_sizes_init[1] = 13; window_sizes_init[2] = 0; window_sizes_init[3] = 0;
...
FaceModelParameters::FaceModelParameters(vector<std::string> &arguments)
{
	// initialise the default values
	init();
...
void FaceModelParameters::init()
{
	...
	model_location = "main_clnf_wild.txt";
