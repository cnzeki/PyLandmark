...
namespace LandmarkDetector
{
	...
	bool DetectLandmarksInImageUseInitOri(const cv::Mat &rgb_image, cv::Rect_<double> bounding_box, CLNF& clnf_model, FaceModelParameters& params, vector<cv::Vec3d>& rotation_hypothese);
